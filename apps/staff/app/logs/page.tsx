...
} from '@/lib/api/staff/activity-logs'
import type {
  ActivityLog,
  ActivityLogFilters,
  ActivityLogStats,
        ...
        <div className="bg-white p-4 rounded-lg shadow mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              >
                <option value="">すべて</option>
                <option value="StaffUser">スタッフ</option>
                <option value="TenantUser">テナント</option>
                <option value="TableSession">顧客</option>
              </select>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
